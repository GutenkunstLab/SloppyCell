...
double p_1 = dynamicVars[4];
double p_2 = dynamicVars[5];
double p_3 = dynamicVars[6];
...
alg_derivs_res[0] = (((0.0) + ((-(1.0))*(yp[(, <, _, a, s, t, ., I, n, d, e, x,  , o, b, j, e, c, t,  , a, t,  , 0, x, 7, f, 8, 8, 5, 0, 2, b, 4, f, 4, 0, >, )]))) + (((Keq) + (1.0))*(yp[(, <, _, a, s, t, ., I, n, d, e, x,  , o, b, j, e, c, t,  , a, t,  , 0, x, 7, f, 8, 8, 5, 0, 2, 3, f, e, 2, 0, >, )])));
}

void alg_res_func_(double *alg_vals, double *dynamicVars, double *time_ptr, double *constants, double *residual){
double time = *time_ptr;

double X0, X1, T, S1, p_1, p_2, p_3;
...
double p_1 = dynamicVars[4];
double p_1_deriv_wrt_time = yprime[4];
double p_2 = dynamicVars[5];
double p_2_deriv_wrt_time = yprime[5];
double p_3 = dynamicVars[6];
double p_3_deriv_wrt_time = yprime[6];
