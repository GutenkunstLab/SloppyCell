...
alg_derivs_res[0] = (((0.0) + ((-(1.0))*(yp[(, <, _, a, s, t, ., I, n, d, e, x,  , o, b, j, e, c, t,  , a, t,  , 0, x, 7, f, 8, 8, 3, c, e, 7, 9, 2, 5, 0, >, )]))) + (((Keq) + (1.0))*(yp[(, <, _, a, s, t, ., I, n, d, e, x,  , o, b, j, e, c, t,  , a, t,  , 0, x, 7, f, 8, 8, 5, 0, 2, 0, 5, 8, 2, 0, >, )])));
}
...
root_devs[1] = ((X0 < 0.8) && (T > 0.3)) - 0.5;
root_devs[2] = (X0 < 0.8) - 0.5;

root_devs[3] = (T > 0.3) - 0.5;
