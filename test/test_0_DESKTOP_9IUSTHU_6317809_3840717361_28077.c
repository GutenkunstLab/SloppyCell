...
alg_derivs_res[0] = (((0.0) + ((-(1.0))*(yp[(, <, _, a, s, t, ., I, n, d, e, x,  , o, b, j, e, c, t,  , a, t,  , 0, x, 7, f, 8, a, 7, 5, 8, 9, a, e, 8, 0, >, )]))) + (((Keq) + (1.0))*(yp[(, <, _, a, s, t, ., I, n, d, e, x,  , o, b, j, e, c, t,  , a, t,  , 0, x, 7, f, 8, a, 7, 5, 8, 9, a, 5, b, 0, >, )])));
}
...
root_devs[2] = (T > 0.3) - 0.5;

root_devs[3] = (X0 < 0.8) - 0.5;
