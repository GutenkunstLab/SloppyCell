...
void dres_dk_new_(double *time_ptr, double *dynamicVars, double *yprime, double *constants, double *pd);
...
alg_derivs_res[0] = (((0.0) + ((-(1.0))*(yp[(, <, _, a, s, t, ., I, n, d, e, x,  , o, b, j, e, c, t,  , a, t,  , 0, x, 7, f, 8, 8, 5, 0, 3, 0, 6, 7, 3, 0, >, )]))) + (((Keq) + (1.0))*(yp[(, <, _, a, s, t, ., I, n, d, e, x,  , o, b, j, e, c, t,  , a, t,  , 0, x, 7, f, 8, 8, 5, 0, 3, 0, 6, 3, 4, 0, >, )])));
}
...
int p_index = (int)constants[5];
double constants_only[5];
int jj;
double *dc_dp;
double *dcdot_dp;
...
break;
case 3 : dres_dk_new_(time_ptr, sens_y, sens_yp, constants_only, local_dres_dp);
break;
}
