...
<!-- generated with COPASI 4.16 (Build 104) (http://www.copasi.org) at 2016-07-11 17:28:31 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="16" versionDevel="104" copasiSourcesModified="0">
  ...
  <Model key="Model_3" name="NoName" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4366" name="D" value="1"/>
          <Constant key="Parameter_4365" name="r1" value="0.5"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4364" name="r3" value="2"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4363" name="r4" value="0"/>
        </ListOfConstants>
    ...
    <ListOfEvents>
      <Event key="Event_0" name="Event_1" delayAssignment="true" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_15">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Compartments[Cytoplasm],Vector=Metabolites[STAT5]" value="7.166348730099999e+23" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Compartments[Cytoplasm],Vector=Metabolites[data2]" value="7.166348730099999e+23" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=NoName,Vector=Compartments[Cytoplasm],Vector=Metabolites[frac_v1]" value="6.02214179e+23" type="Species" simulationType="assignment"/>
    ...
    <InitialState type="initialState">
      0 7.166348730099999e+23 0 0 0 1 1 0 7.166348730099999e+23 6.02214179e+23 0 0 0 1 1 0.5 2 0 6 1.35 1.19 1 1 
    </InitialState>
  </Model>
  <ListOfTasks>
