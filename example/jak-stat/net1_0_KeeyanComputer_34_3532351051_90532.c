...
double v1, v2, v3, v4, r4, smooth_D_slope, smooth_D_offset;
double Cytoplasm, Nucleus, r1, r3, tao, r4_0, v1_0;
double data1, data2, smooth_D, D, frac_v1, frac_v2, frac_v3, frac_v4;

Cytoplasm = constants[0];
Nucleus = constants[1];
r1 = constants[2];
r3 = constants[3];
tao = constants[4];
...
v4 = dynamicVars[3];
r4 = dynamicVars[4];
smooth_D_slope = dynamicVars[5];
smooth_D_offset = dynamicVars[6];

data1 = v2 + 2.0*v3;
data2 = v1 + v2 + 2.0*v3;
smooth_D = smooth_D_slope*time + smooth_D_offset;
D = smooth_D;
frac_v1 = v1/v1_0;
frac_v2 = v2/v1_0;
frac_v3 = 2.0*v3/v1_0;
