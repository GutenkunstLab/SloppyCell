...
void dres_dxIC_(double *time_ptr, double *dynamicVars, double *yprime, double *constants, double *pd);
...
break;
case 2 : dres_dxIC_(time_ptr, sens_y, sens_yp, constants_only, local_dres_dp);
break;
}
