...
def principleAnglesAndVectors(A, B):
    """
    Computes the principle angles and vectors between two subspaces via SVD. See Bjorck and Golub, "Numerical Methods for Computing Between Linear Subspaces" _Mathematics_of_Computation_, 27(123), 1973, pp. 579-594
    """
    if A.shape[0] != B.shape[0]:
        raise ValueError, 'Input subspaces must live in the same dimensional space.'
...
def test():
    ...
    theta, U, V = principleAnglesAndVectors(A, B)
