...
class test_AlgebraicRules(unittest.TestCase):
    def test_basic(self):
        ...
        self.assertAlmostEqual(algebraic_traj.get_var_val('T', 29.6), 0.138253942, 5)
        self.assertAlmostEqual(algebraic_traj.get_var_val('S1', 40.0), 0.018207409, 5)
...
rules are parsed correctly"""
        ...
        # implicitly constant because no equations modify it.  We need to check to
        # make sure it's not being identified as an algebraic variable.
        ...
        # finally, we check to make sure the algebraic variables list is the correct
        # length
